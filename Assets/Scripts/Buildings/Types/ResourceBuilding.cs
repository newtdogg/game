...
public class ResourceBuilding : Building
{
    ...
    public ResourceBuilding(string buildingName, string t, string upgradeT, string desc, bool isUnlocked, int w, int h, Dictionary<string, int> cst) : base(buildingName, t, upgradeT, desc, isUnlocked, w, h, cst)
    {
        name = buildingName;
